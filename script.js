...
function getCategories(data) {
  ...
  data.forEach(row => {
    ...
    let cat = 'Other';
    if (
      payee.includes('grocery') ||
      payee.includes('market') ||
      payee.includes('fresh') ||
      payee.includes('tom thumb') ||
      payee.includes('walmart') ||
      payee.includes('supercenter')
    ) cat = 'Grocery';
    else if (
      payee.includes('medical') ||
      payee.includes('clinic') ||
      payee.includes('dental') ||
      payee.includes('bswhealth') ||
      payee.includes('hospital')
    ) cat = 'Medical';
    else if (
      payee.includes('cafe') ||
      payee.includes('restaurant') ||
      payee.includes('potbelly') ||
      payee.includes('bagel') ||
      payee.includes('beans') ||
      payee.includes('jersey mikes') ||
      payee.includes('burger') ||
      payee.includes('starbucks')
    ) cat = 'Dining';
    else if (
      payee.includes('clip') ||
      payee.includes('beauty') ||
      payee.includes('salon')
    ) cat = 'Personal Care';
    else if (
      payee.includes('payment') ||
      payee.includes('salary')
    ) cat = 'Income';
    else if (
      payee.includes('mobile') ||
      payee.includes('spectrum') ||
      payee.includes('electricity') ||
      payee.includes('utilities')
    ) cat = 'Utilities';
    else if (
      payee.includes('gofundme') ||
      payee.includes('heifer')
    ) cat = 'Charity';
    row['Category'] = cat;
